...
This works for research, escalated code review, debugging, TDD, escalated security audits, UI design, PRDs, and full build-to-ship workflows — 52 commands, 59 skills, 32 specialized personas.
...
- [**Command Reference**](../docs/COMMAND-REFERENCE.md) — all 52 commands with triggers
