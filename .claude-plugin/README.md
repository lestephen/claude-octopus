...
This works for research, escalated code review, debugging, TDD, escalated security audits, UI design, PRDs, and full build-to-ship workflows — 51 commands, 58 skills, 32 specialized personas.
