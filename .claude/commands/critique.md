...
argument-hint: '[--scope-type code-change|design-doc|technology-choice|approach|architecture|decision] [--audience internal-skeptic|customer|expert-peer|competitor] [--angles list,of,angles] <target>'
---
